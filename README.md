...
Update the language encoding or timezone of the docker build by adding `--build-args`

```
$ docker build --build-arg TZ=Europe/London --build-arg LANG=en_US.UTF-8 -t playball .
```
